...
public interface CloudServersApi extends Closeable {
   ...
   void shareIp(@PathParam("address") String addressToShare,
   ...
   void unshareIp(@PathParam("address") String addressToShare,
   ...
   Image createImageFromServer(@PayloadParam("name") String imageName,
